...
const KOREAN: Translations = {
  ...
  [Phrase.FirstTimeHere]:
    "처음 사용하는 경우 아래 링크에서 설정 방법을 확인할 수 있습니다.",
  ...
  [Phrase.StoragePathDescription]:
    "기록을 저장할 위치. 프로그램이 폴더의 소유권을 가지며, 초기 설정 시 비어 있어야 하며 그 자리에서 내용을 수정해서는 안 됩니다.(영문 폴더명 권장)",
  [Phrase.SeparateBufferPathDescription]:
    "임시 기록을 별도의 위치에 저장할 수 있도록 설정합니다.",
  [Phrase.BufferStoragePathDescription]:
    "임시 기록을 저장할 위치. 설정하지 않은 채로 두면 기본 저장 경로에서 관리됩니다.",
  [Phrase.RetailLogPathDescription]:
    '본섭 로그 폴더 위치 (ex: "World of Warcraft\\_retail_\\Logs")',
  [Phrase.ClassicLogPathDescription]:
    '클래식 로그 폴더 위치 (ex: "World of Warcraft\\_classic_\\Logs")',
  [Phrase.EraLogPathDescription]:
    '클래식 시대 로그 폴더 위치 (ex: "World of Warcraft\\_classic_era_\\Logs")',
  [Phrase.MaxStorageDescription]:
    '저장소 최대 허용 용량. 무제한은 "0"으로 설정. 범위 내로 유지되도록 가장 오래된 기록물은 하나씩 삭제됩니다.',
  [Phrase.MonitorIndexDescription]:
    "모니터가 여러 대일 경우 개별 항목이 생성되어 기록을 원하는 모니터를 선택할 수 있습니다.",
  ...
  [Phrase.MinEncounterDurationDescription]:
    "이 시간보다 짧은 전투는 기록되지 않습니다. 이 설정은 보스 리셋이 저장되지 않도록 하는데 목적이 있습니다.",
  ...
  [Phrase.ObsOutputResolutionDescription]:
    "기록물의 해상도. 게임 해상도 크기로 설정 또는 그 이하",
  [Phrase.ObsFPSDescription]:
    "기록물의 초당 프레임 수. FPS가 낮을수록 동영상 크기는 작아지지만 재생이 원할하지 않습니다.",
  [Phrase.ObsForceMonoDescription]:
    "입력 장치를 모노로 강제할지 여부. 오디오 마이크가 하나의 스테레오 채널에서만 재생되는 경우 활성화",
  [Phrase.ObsQualityDescription]:
    "기록물 품질. 높을수록 더 많이 작동하고 더 많은 디스크 공간을 사용합니다.",
  [Phrase.ObsCaptureModeDescription]: "녹화할 때 사용할 모드",
  [Phrase.ObsRecEncoderDescription]:
    "사용할 비디오 인코더. 일반적으로 하드웨어(Hardware) 인코더 권장",
  ...
  [Phrase.PushToTalkModifiersDescription]:
    "PTT 단축키와 함께 필요한 수식어의 쉼표로 구분된 목록",
  [Phrase.PushToTalkReleaseDelayDescription]:
    "PTT 키에서 손을 뗀 후 마이크가 활성 상태로 유지되는 시간입니다.",
  [Phrase.ObsAudioSuppressionDescription]:
    "마이크에 잡히는 배경 소음을 억제하는데 도움이 될 수 있습니다.",
  ...
  [Phrase.CloudUploadDescription]:
    "클라우드 업로드 모드 활성화 & 설정. 기록이 완료되면 자동으로 클라우드에 업로드되며, 기존 동영상도 수동으로 업로드 할 수 있습니다.",
  [Phrase.CloudUploadRetailDescription]:
    "본섭 동영상을 클라우드에 업로드해야 하는 경우.",
  [Phrase.CloudUploadClassicDescription]:
    "클래식 동영상을 클라우드에 업로드해야 하는 경우.",
  [Phrase.CloudUploadRateLimitDescription]:
    "클라우드 업로드 속도를 제한해야 하는 경우 (업로드가 지연되는 경우 유용)",
  ...
  [Phrase.TestButtonUnable]:
    "지금은 테스트를 실행할 수 없습니다. 테스트를 실행하려면 게임이 실행 중이어야 하고, 설정이 유효해야 하며 현재 활동 중이 아니어야 합니다.",
  ...
  [Phrase.SettingsDisabledText]:
    "기록이 활성화된 동안에는 이러한 설정을 수정할 수 없습니다.",
  [Phrase.SomeSettingsDisabledText]:
    "기록이 활성화되어 있는 동안에는 일부 설정을 수정할 수 없습니다.",
  [Phrase.CloudSettingsDisabledText]:
    "클라우드 설정은 업로드 또는 다운로드가 진행 중일 때 수정할 수 없습니다.",
  ...
  [Phrase.StatusDescriptionForceEnd]:
    "기록을 강제로 종료할 수 있습니다. 일반적으로 이 선택은 필요하지 않습니다. 실패한 쐐기+를 강제 종료하는 데 도움이 될 수 있습니다.",
  ...
  [Phrase.CrashHappenedText]:
    "OBS 충돌이 발생하여 복구되었습니다. 정상적인 작동에서는 이런 일이 일어나지 않아야 합니다.",
  ...
  [Phrase.ShareableLinkText]:
    "이 링크는 동영상이 클라우드에 저장되어 있는 동안 유효합니다.",
  ...
  [Phrase.ErrorUserNotAuthorizedPlayback]:
    "클라우드에 접근할 수 있는 권한이 없습니다.",
  [Phrase.ErrorUserNotAuthorizedUpload]:
    "클라우드에 업로드할 수 있는 권한이 없습니다.",
  ...
  [Phrase.ErrorCustomOverlayNotAllowed]:
    "사용자 지정 오버레이를 사용하려면 클라우드 모드를 사용 설정하세요.",
  [Phrase.ErrorNoCustomImage]:
    "사용자 지정 오버레이 이미지 경로가 지정되지 않았습니다.",
  [Phrase.ErrorCustomImageFileType]:
    "오버레이 이미지는 .png 또는 .gif 파일이어야 합니다.",
  ...
  [Phrase.MultipleTagged]:
    "이 행에는 태그가 지정된 기록이 여러 개 포함되어 있습니다.",
  [Phrase.NoneStarred]:
    "이 행은 잠겨 있지 않습니다. 기록이 오래되면 자동 삭제될 수 있습니다.",
  ...
  [Phrase.RetailPtrLogPathDescription]:
    '본섭 PTR 로그 폴더 위치 (ex: "World of Warcraft\\_xptr_\\Logs")',
  ...
  [Phrase.PermissionDescription]:
    "관리자가 부여한 현재 선택된 서버 내 접근 권한 수준입니다.",
  ...
  [Phrase.ShowBothTooltip]:
    "디스크 및 클라우드 동영상을 그룹화하고 모든 동영상을 표시합니다.",
  ...
  [Phrase.HardwareAccelerationDescription]:
    "프로그램의 하드웨어 가속 렌더링을 활성화합니다. 이 기능은 대부분의 사용자에게 권장되며, 특히 AV1 인코딩을 사용하는 경우에 유용하지만 일부 시스템에서는 문제가 발생할 수 있습니다. 이 변경 사항은 프로그램을 재시작해야 적용됩니다.",
  [Phrase.RecordCurrentRaidsOnlyLabel]: "현재 시즌 레이드만",
  [Phrase.RecordCurrentRaidsOnlyDescription]:
    "현재 시즌의 레이드 전투만 기록합니다. 이는 본섭 레이드 전투에만 적용됩니다.",
  [Phrase.UploadCurrentRaidsOnlyLabel]: "현재 시즌 레이드만",
  [Phrase.UploadCurrentRaidsOnlyDescription]:
    "현재 시즌의 레이드 전투만 업로드합니다. 이는 본섭 레이드 전투에만 적용됩니다.",
  ...
  [Phrase.StatusDescrNotAuthorized]:
    "로그인은 성공했지만 선택한 서버에 접근할 권한이 없습니다.",
  [Phrase.FirstTimeSetupDescription]:
    "사용자가 처음으로 앱을 실행한 경우입니다.",
  [Phrase.AutoSelectEncoderTooltip]:
    "사용 가능한 옵션 중 합리적인 인코더를 자동으로 선택합니다. 대부분의 사용자에게 적합합니다.",
  ...
  [Phrase.ResetGameButtonText]: "게임 초기화",
  ...
  [Phrase.SelectADevice]: "",
  [Phrase.SelectAnApplication]: "",
