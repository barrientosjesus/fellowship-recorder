import { Phrase, Translations } from "./phrases";

/* eslint-disable prettier/prettier */
const GERMAN: Translations = {
  [Phrase.NoVideosSaved]:
    "Du hast keine Videos in dieser Kategorie gespeichert.",
  [Phrase.FirstTimeHere]:
    "Wenn du das erste Mal die Anwendung gestartet hast, können Installationsanweisungen dem folgenden Link entnommen werden. Falls du Probleme haben solltest, nutz bitte den Discord #help Kanal um Unterstützung zu bekommen.",
  ...
  [Phrase.BufferStoragePathDescription]:
    "Speicherort für Puffer Aufnahmen. Wenn dieser nicht gesetzt ist, wird der normale Speicherort genutzt.",
  [Phrase.RetailLogPathDescription]:
    'Speicherort deines Logs Ordners von deiner Retail World of Warcraft Installation, e.g. "D:\\World of Warcraft\\_retail_\\Logs".',
  [Phrase.ClassicLogPathDescription]:
    'Speicherort deines Logs Ordners von deiner Classic World of Warcraft Installation, e.g. "D:\\World of Warcraft\\_classic_\\Logs".',
  [Phrase.EraLogPathDescription]:
    'Speicherort deines Logs Ordners von deiner Classic Era World of Warcraft Installation, e.g. "D:\\World of Warcraft\\_classic_era_\\Logs".',
  [Phrase.MaxStorageDescription]:
    "Maximal erlaubte Speichergröße, den die Anwendungen für Videodateien nutzen darf. Die ältesten Videos werden nach und nach gelöscht, um sicherzustellen, dass man unter der gesetzten Speichergröße bleibt. Aufnahmen werden nicht gestoppt. Auf 0 setzen, um unbegrenzten Speicherplatz zu erlauben.",
  [Phrase.MonitorIndexDescription]:
    "Der Monitor wird aufgenommen. Nur anwendbar, wenn Monitor Aufnahme ausgewählt ist.",
  [Phrase.SelectedCategoryDescription]:
    "Zuletzt ausgewählte Video Kategorie in der Benutzeroberfläche.",
  [Phrase.AudioInputDevicesDescription]:
    "Audioeingabegeräte, die in Aufnahme inbegriffen sein sollen.",
  [Phrase.AudioOutputDevicesDescription]:
    "Audioausgabegeräte, die in Aufnahme inbegriffen sein sollen.",
  [Phrase.MinEncounterDurationDescription]:
    "Bosskämpfe die kürzer als die gesetzte Dauer sind werden nicht aufgenommen. Diese Einstellung soll vermeiden, dass Boss Resets aufgenommen werden.",
  [Phrase.StartUpDescription]:
    "Starte die Anwendung automatisch, wenn Windows startet..",
  [Phrase.StartMinimizedDescription]:
    "Öffnet die Anwendung minimiert zur Taskleiste.",
  [Phrase.ObsOutputResolutionDescription]:
    "Auflösung von Aufnahmen, die auf der Festplatte gespeichert werden.Stell dies auf die Auflösung deines Monitors oder auf weniger, wenn du es runterskalieren möchtest.",
  [Phrase.ObsFPSDescription]:
    "Die Anzahl der Bilder pro Sekunde(FPS) mit der das Video aufgenommen werden soll. Niedrigere FPs erzeugen kleinere Videodateien, aber auch zu einer abgehackteren Wiedergabe.",
  [Phrase.ObsForceMonoDescription]:
    "Legt fest, ob das Audioeingabegerät in Mono aufgenommen werden soll. Option einschalten, wenn dein Mikrofon nur über einen Stereokanal ausgegeben wird.",
  [Phrase.ObsQualityDescription]:
    "Qualität in der aufgenommen werden soll. Höhere Qualität belastet den Encoder stärker und verbraucht mehr Speicherplatz pro Video.",
  [Phrase.ObsCaptureModeDescription]:
    "Der Aufnahmemodus der von OBS zur Aufnahme genutzt werden soll. Finde mehr Informationen dazu im Discord #faq Kanal.",
  [Phrase.ObsRecEncoderDescription]:
    "Der Video-Encoder, der genutzt werden soll. Hardware Encoder werden in der Regel bevorzugt und gibt bessere Leistung, aber dies ist spezifisch du deiner Grafikkarte.",
  ...
  [Phrase.RecordRaidsDescription]:
    "Ob die Anwendung Schlachtzüge aufnehmen soll.",
  [Phrase.RecordDungeonsDescription]:
    "Ob die Anwendung Mythisch+ aufnehmen soll.",
  ...
  [Phrase.RecordSkirmishDescription]:
    "Ob die Anwendung Geplänkel aufnehmen soll.",
  [Phrase.RecordSoloShuffleDescription]:
    "Ob die Anwendung Gemischtes Einzel aufnehmen soll",
  [Phrase.RecordBattlegroundsDescription]:
    "Ob die Anwendung Schlachtfelder aufnehmen soll.",
  [Phrase.CaptureCursorDescription]:
    "Ob die Anwendung Mauszeiger aufnehmen soll",
  [Phrase.MinKeystoneLevelDescription]:
    "Die Schlüsselsteinstufe ab dem  aufgenommen werden soll..",
  [Phrase.ChallengeModeDescription]:
    "Ob Herausforderungsmodi aufgenommen werden sollen.",
  [Phrase.MinRaidDifficultyDescription]:
    "Die Schwierigkeitsstufe ab dem ein Schlachtzug aufgenommen werden soll - wird nur auf Retail angewendet.",
  [Phrase.MinimizeOnQuitDescription]:
    "Ob die Schließen-Schaltfläche die Anwendung minimieren soll anstatt zu beenden.",
  [Phrase.MinimizeToTrayDescription]:
    "Ob die Minimieren-Schaltfläche die Anwendung zur System Tray oder Taskleiste minimiert werden soll",
  [Phrase.ChatOverlayEnabledDescription]:
    "Ob ein Chat Overlay zur Szene hingefügt werden soll.",
  [Phrase.ChatOverlayOwnImageDescription]:
    "Ob ein benutzerdefiniertes Bild als Chat Overlay genutzt werden soll. Dieses Feature ist nur zugänglich für Pro-Nutzer.",
  [Phrase.ChatOverlayOwnImagePathDescription]:
    "Die PNG Datei, die als Chat Overlay genutzt werden soll. Dieses Feature ist nur zugänglich für Pro-Nutzer.",
  ...
  [Phrase.ChatOverlayXPositionDescription]:
    "Die X-Position von dem Chat Overlay.",
  [Phrase.ChatOverlayYPositionDescription]:
    "Die Y-Position von dem Chat Overlay.",
  [Phrase.SpeakerVolumeDescription]:
    "Die Lautstärke mit der dein Audioausgabegerät aufgenommen werden soll, von 0 bis 1.",
  [Phrase.MicVolumeDescription]:
    "Die Lautstärke mit der ein Audioeingabegerät aufgenommen werden soll, von 0 bis 1.",
  [Phrase.DeathMarkersDescription]:
    "Todes Markierungen in der Video Zeitleiste anzeigen.",
  [Phrase.EncounterMarkersDescription]:
    "Bosskampf Markierungen in der Video Zeitleiste anzeigen.",
  [Phrase.RoundMarkersDescription]:
    "Runden Markierungen in der Video Zeitleiste anzeigen.",
  [Phrase.PushToTalkDescription]:
    "Ob das Audioeingabegerät durchgehend aufgenommen werden soll oder nur, wenn ein Hotkey runter gedrückt wird",
  [Phrase.PushToTalkKeyDescription]:
    "Der  Hotkey, dargestellt durch die Tastenbezeichnung/Tastenkombination",
  [Phrase.PushToTalkMouseButtonDescription]:
    "Die Drücken zum sprechen Maustaste.",
  [Phrase.PushToTalkModifiersDescription]:
    "Eine Kommata getrennte Liste von Modifizierungstasten in Verbindung mit deinem Drücken zum sprechen Hotkey.",
  [Phrase.PushToTalkReleaseDelayDescription]:
    "Wie lange Ihr Mikrofon aktiv bleibt, nachdem Sie die Push-to-Talk-Taste losgelassen haben.",
  [Phrase.ObsAudioSuppressionDescription]:
    "Unterdrückung von Hintergrundgeräuschen, die dein Mirkofon aufnimmt. Dies kann dafür sorgen, dass man z.B. den Tastenschlag,Atmung, etc. weniger hört.",
  [Phrase.RaidOverrunDescription]:
    "Anzahl der Sekunden die nach einem Bosskill noch aufgenommen werden soll.",
  [Phrase.DungeonOverrunDescription]:
    "Anzahl der Sekunden die nach einem Instanzabschluss noch aufgenommen werden soll.",
  [Phrase.CloudStorageDescription]: "Anschalten der Cloud Wiedergabe.",
  [Phrase.CloudUploadDescription]:
    "Lade deine Videos in die Cloud hoch. Dies schaltet sowohl das automatische hochladen von Aufnahmen als auch die manuelle Option bestehende Videos hochzuladen ein",
  [Phrase.CloudUploadRetailDescription]:
    "Wenn Retail in die Cloud hochgeladen werden sollen.",
  [Phrase.CloudUploadClassicDescription]:
    "Wenn Classic in die Cloud hochgeladen werden sollen.",
  ...
  [Phrase.CloudUpload2v2Description]:
    "Ob die 2v2 Aufnahmen in die Cloud hochgeladen werden sollen.",
  [Phrase.CloudUpload3v3Description]:
    "Ob die 3v3 Aufnahmen in die Cloud hochgeladen werden sollen.",
  [Phrase.CloudUpload5v5Description]:
    "Ob die 5v5 Aufnahmen in die Cloud hochgeladen werden sollen.",
  [Phrase.CloudUploadSkirmishDescription]:
    "Ob die Geplänkel Aufnahmen in die Cloud hochgeladen werden sollen.",
  [Phrase.CloudUploadSoloShuffleDescription]:
    "Ob die Gemischtes Einzel Aufnahmen in die Cloud hochgeladen werden sollen.",
  [Phrase.CloudUploadDungeonsDescription]:
    "Ob die Mythisch+ Aufnahmen in die Cloud hochgeladen werden sollen.",
  [Phrase.CloudUploadRaidsDescription]:
    "Ob die Schlachtzug Aufnahmen in die Cloud hochgeladen werden sollen.",
  [Phrase.CloudUploadBattlegroundsDescription]:
    "Ob die Schlachtfelder Aufnahmen in die Cloud hochgeladen werden sollen.",
  [Phrase.CloudUploadRaidMinDifficultyDescription]:
    "Die Schwierigkeitsstufe ab der automatisch in die Cloud hochgeladen werden soll",
  [Phrase.CloudUploadDungeonMinLevelDescription]:
    "Die Schlüsselsteinstufe ab der automatisch in die Cloud hochgeladen werden soll",
  ...
  [Phrase.UploadDifficultyThresholdLabel]:
    "Schwierigkeitsstufen Schwelle zum hochladen",
  [Phrase.UploadMythicPlusLabel]: "Mythisch+ hochladen",
  [Phrase.UploadLevelThresholdLabel]:
    "Schlüsselsteinstufen Schwelle zum hochladen",
  ...
  [Phrase.SettingsDisabledText]:
    "Diese Einstellungen können nicht bearbeitet werden während eine Aufnahme läuft.",
  [Phrase.SomeSettingsDisabledText]:
    "Einige Einstellung in der Kategorie sind aktuell versteckt, da diese nicht bearbeitet werden können während eine Aufnahme läuft.",
  [Phrase.CloudSettingsDisabledText]:
    "Cloud-Einstellungen können nicht geändert werden, während Uploads oder Downloads im Gange sind.",
  ...
  [Phrase.SearchSuggestionMythicPlus]:
    "Probier: timed Tempel gestern +18 Priester Lesezeichen verstärkt",
  [Phrase.SearchSuggestionRaid]:
    "Probier: Sieg heute retail mythisch zerstörung Lesezeichen",
  [Phrase.SearchSuggestionBattlegrounds]:
  ...
  [Phrase.SearchSuggestionDefault]:
    "Probier: Sieg Enigmatiegel Arkan Lesezeichen",
  ...
  [Phrase.ClipUnavailableTooltip]:
    "Du kannst nur lokal gespeicherte Videos clipen",
  ...
  [Phrase.TagDialogText]:
    "Diese Beschreibung ist in der Suchleiste durchsuchbar.",
  [Phrase.Clear]: "Löschen",
  [Phrase.Save]: "Speichern",
  [Phrase.ShareableLinkTitle]:
    "Teilbarer Link wurde generiert und befindet sich in deiner Ablage.",
  [Phrase.ShareableLinkText]:
    "Dieser Link ist gültig, solange das Video in der Cloud gespeichert bleibt.",
  ...
  [Phrase.ErrorUserNotAuthorizedPlayback]:
    "Benutzer ist nicht berechtigt auf diese Gilde zuzugreifen.",
  [Phrase.ErrorUserNotAuthorizedUpload]:
    "Benutzer ist nicht berechtigt auf diese Gilde hochzuladen.",
  ...
  [Phrase.ErrorStoragePathSameAsBufferPath]:
    "Speicher Pfad ist der gleiche wie der  Buffer Pfad.",
  [Phrase.ErrorCustomOverlayNotAllowed]:
    "Um ein benutzerdefiniertes Overlay zu nutzen, aktiviere den Cloud Speicher.",
  [Phrase.ErrorNoCustomImage]:
    "Overlay Bild wurde nicht übergeben von benutzerdefiniertes Overlay.",
  [Phrase.ErrorCustomImageFileType]:
    "Overlay Bild muss eine .png oder .gif Datei sein.",
  ...
  [Phrase.End]: "Ende",
  [Phrase.Cloud]: "Cloud",
  [Phrase.Disk]: "Festplatte",
  [Phrase.Starred]: "Markiert",
  [Phrase.NotStarred]: "Nicht markiert",
  ...
  [Phrase.SomeStarred]:
    "Diese Zeile enthält mindestens eine markierte Aufnahme.",
  [Phrase.UploadClipsLabel]: "Clips hochladen",
  [Phrase.CloudUploadClipsDescription]:
    "Wenn abgeschnittene Aufnahmen in die Cloud hochgeladen werden sollen.",
  [Phrase.RetailPtrLogPathDescription]:
    'Speicherort deines Logs Ordners von deiner Retail PTR World of Warcraft Installation, e.g. "D:\\World of Warcraft\\_xptr_\\Logs".',
  [Phrase.RecordRetailPtrDescription]:
    "Ob die Anwendung Retail aufnehmen soll.",
  ...
  [Phrase.MultiPlayerModeAdvice1]:
    "Mithilfe des Rasters auf der linken Seite können Sie bis zu 4 Spieler gleichzeitig auswählen bzw. die Auswahl aufheben.",
  [Phrase.MultiPlayerModeAdvice2]:
    "Um die hier normalerweise angezeigten Schaltflächen wiederherzustellen, kehren Sie zum Einzelspielermodus zurück.",
  [Phrase.UpdateAvailableTooltip]:
    "Ein Update ist verfügbar. Klicken Sie hier, um es zu installieren.",
  [Phrase.UpdateAvailableTitle]: "Update verfügbar",
  [Phrase.UpdateAvailableText]:
    "Es ist ein Update verfügbar und kann installiert werden.",
  ...
  [Phrase.DateFilter]: "Datumsfilter",
  [Phrase.DateFilterSeparator]: "bis",
  [Phrase.Last7Days]: "Letzte 7 Tage",
  [Phrase.Last30Days]: "Letzte 30 Tage",
  [Phrase.ThisMonth]: "Diesen Monat",
  [Phrase.LastMonth]: "Letzten Monat",
  [Phrase.Cancel]: "Abbrechen",
  [Phrase.Apply]: "Anwenden",
  [Phrase.January]: "Januar",
  [Phrase.February]: "Februar",
  [Phrase.March]: "März",
  [Phrase.April]: "April",
  [Phrase.May]: "Mai",
  [Phrase.June]: "Juni",
  ...
  [Phrase.October]: "Oktober",
  [Phrase.November]: "November",
  [Phrase.December]: "Dezember",
  [Phrase.Sunday]: "Sonntag",
  [Phrase.Monday]: "Montag",
  [Phrase.Tuesday]: "Dienstag",
  [Phrase.Wednesday]: "Mittwoch",
  ...
  [Phrase.PermissionDescription]:
    "Die Zugriffsebene, die Ihnen innerhalb der aktuell ausgewählten Gilde vom Gildenadministrator gewährt wurde.",
  ...
  [Phrase.PermissionWriteDescription]:
    "Ermöglicht das Hochladen, Markieren und Sperren von Videos.",
  [Phrase.PermissionDeleteLabel]: "Löschen",
  [Phrase.PermissionDeleteDescription]:
    "Ermöglicht das Löschen und Entsperren von Videos.",
  [Phrase.ButtonDiskOnlyDescription]:
    "Aktivieren Sie diese Option, um Schaltflächen nur auf lokale Videos anzuwenden und alle Cloud-Videos und relevanten Gildenzugriffsberechtigungen zu ignorieren.",
  ...
  [Phrase.ShowBothTooltip]:
    "Gruppieren Sie Disk- und Cloud-Videos und zeigen Sie alles",
  [Phrase.GuildNoPermission]:
    "Nicht genügend Gildenberechtigungen, um diese Aktion auszuführen.",
  [Phrase.RemoveTagFromList]: "%value% aus der Liste entfernen",
  [Phrase.DownloadUploadDisabledDueToFilter]:
    "Aufgrund des aktuell ausgewählten Speicherfilters deaktiviert.",
  [Phrase.ProcessesLabel]: "Anwendungen",
  [Phrase.SelectProcess]: "Wählen Sie eine Anwendung aus",
  [Phrase.AudioProcessDevicesDescription]:
    "Anwendungen zum Aufnehmen von Audiodaten, zusätzlich zu allen ausgewählten Lautsprechern und Mikrofonen.",
  [Phrase.ProcessVolumeDescription]:
    "Die Lautstärke der Anwendung in der Aufnahme, von 0 bis 1.",
  [Phrase.HideEmptyCategoriesLabel]: "Leere Kategorien ausblenden",
  [Phrase.HideEmptyCategoriesDescription]:
    "Blendet Kategorien im Seitenmenü aus, die keine Videos enthalten.",
  [Phrase.HardwareAccelerationLabel]: "Hardwarebeschleunigung",
  [Phrase.HardwareAccelerationDescription]:
    "Aktivieren Sie die hardwarebeschleunigte Darstellung der Anwendung. Dies wird den meisten Benutzern empfohlen, insbesondere denen mit AV1-Kodierung, kann aber auf manchen Systemen zu Problemen führen.",
  [Phrase.RecordCurrentRaidsOnlyLabel]: "Nur aktuelle Raids aufzeichnen",
  [Phrase.RecordCurrentRaidsOnlyDescription]:
    "Zeichne nur Raid-Begegnungen der aktuellen Stufe auf, dies gilt nur für Retail-Raid-Begegnungen.",
  [Phrase.UploadCurrentRaidsOnlyLabel]: "Nur aktuelle Raids hochladen",
  [Phrase.UploadCurrentRaidsOnlyDescription]:
    "Laden Sie nur Raid-Begegnungen der aktuellen Stufe hoch. Dies gilt nur für Einzelhandels-Raid-Begegnungen.",
  [Phrase.MustNotBeEmpty]: "Darf nicht leer sein",
  [Phrase.PushToTalkReleaseDelayLabel]: "Verzögerung bei der Veröffentlichung",
  [Phrase.ForceSdrLabel]: "SDR erzwingen",
  [Phrase.ForceSdrDescription]:
    "Erzwingt, dass das Video in SDR anstatt HDR gerendert wird.",
  [Phrase.VideoSourceScaleDescription]: "Die Skalierung der Videoquelle.",
  [Phrase.VideoSourceXPositionDescription]: "Die X-Position der Videoquelle.",
  [Phrase.VideoSourceYPositionDescription]: "Die Y-Position der Videoquelle.",
  [Phrase.VideoCategoryManualLabel]: "Manuell",
  [Phrase.ManualRecordSettingsLabel]: "Manuelle Einstellungen",
  [Phrase.ManualRecordSwitchLabel]: "Manuelle Aufnahme",
  [Phrase.ManualRecordHotKeyLabel]: "Start/Stopp Hotkey",
  [Phrase.ManualRecordUploadLabel]: "Manuelle Aufnahmen hochladen",
  [Phrase.ManualRecordDescription]:
    "Aktiviert manuelle Aufnahme, die ein Benutzer nach Bedarf starten und stoppen kann, um Dinge aufzunehmen, die nicht vom Kampflog erfasst werden.",
  [Phrase.ManualRecordHotKeyDescription]:
    "Setze einen Hotkey, um die Aufnahme manuell zu starten und zu stoppen.",
  [Phrase.ManualRecordUploadDescription]:
    "Automatisches Hochladen von manuell gestarteten Aufnahmen in die Cloud.",
  [Phrase.ManualRecordSoundAlertLabel]: "Ton-Alarm",
  [Phrase.ManualRecordSoundAlertDescription]:
    "Spiele einen Ton-Alarm ab, wenn die manuelle Aufnahme startet oder stoppt.",
  [Phrase.StatusTitleRec]: "Recorder",
  [Phrase.StatusTitlePro]: "Pro",
  [Phrase.StatusTitleConnected]: "Verbunden",
  [Phrase.StatusDescrConnected]:
    "Gildenverbindung hergestellt. Pro-Features sind aktiviert.",
  [Phrase.StatusTitleDisconnected]: "Getrennt",
  [Phrase.StatusDescrDisconnected]:
    "Um Pro-Features zu nutzen, kaufe ein Gilden-Abonnement oder tritt einer bestehenden Gilde bei und konfiguriere deine Anmeldedaten auf der Pro-Einstellungsseite.",
  [Phrase.StatusTitleNotAuthenticated]: "Nicht authentifiziert",
  [Phrase.StatusDescrNotAuthenticated]:
    "Anmeldung fehlgeschlagen, bitte überprüfe, ob deine Zugangsdaten gültig sind.",
  [Phrase.StatusTitleNoGuild]: "Keine Gilde",
  [Phrase.StatusDescrNoGuild]:
    "Ihre Anmeldung war erfolgreich, Sie haben jedoch keine Gilde ausgewählt.",
  [Phrase.StatusTitleNotAuthorized]: "Kein Zugriff",
  [Phrase.StatusDescrNotAuthorized]:
    "Deine Anmeldung war erfolgreich, aber du bist nicht berechtigt, auf die ausgewählte Gilde zuzugreifen.",
  [Phrase.FirstTimeSetupDescription]:
    "Dies ist das erste Mal, dass der Benutzer die Anwendung gestartet hat.",
  [Phrase.AutoSelectEncoderTooltip]:
    "Wählen Sie automatisch einen sinnvollen Encoder aus den verfügbaren aus. Eine gute Option für die meisten Benutzer.",
  [Phrase.CloudRefreshGuildTooltip]:
    "Aktualisieren Sie die Liste der verfügbaren Gilden.",
  ...
  [Phrase.NoAudioSourcesText]:
    "Fügen Sie eine Quelle hinzu, um Audio aufzunehmen.",
  [Phrase.SelectADevice]: "Wählen Sie ein Gerät aus...",
  [Phrase.SelectAnApplication]: "Wählen Sie eine Anwendung aus...",

  // Fellowship Stuff
  [Phrase.VideoCategoryAdventuresLabel]: "Adventures",
  [Phrase.VideoCategoryQuickplaysLabel]: "Quickplays",
  [Phrase.VideoCategoryDungeonsLabel]: "Dungeons",
  [Phrase.FellowshipLogPathDescription]:
    "Location of the Fellowship logs folder for your fellowship installation.",
  [Phrase.RecordAdventuresDescription]:
    "Whether the application should record adventures. (One boss dungeon)",
  [Phrase.RecordQuickplaysDescription]:
    "Whether the application should record quickplays.",
  [Phrase.HeroBlacklistDescription]:
    "A list of heroes you don't want to record.",
  [Phrase.MinDifficultyLevelDescription]:
    "The minimum difficulty level to record.",
  [Phrase.CloudUploadQuickplaysDescription]:
    "If quickplay recordings should be uploaded to the cloud.",
  [Phrase.CloudUploadAdventuresDescription]:
