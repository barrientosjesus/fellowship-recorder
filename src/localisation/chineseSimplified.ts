...
const CHINESE_SIMPLIFIED: Translations = {
  ...
  [Phrase.FirstTimeHere]:
    "如果这是你第一次使用，下面的链接中可以找到设置说明。如果你遇到问题，请在 Discord 的 #help 频道寻求支持。",
  ...
  [Phrase.BufferStoragePathDescription]:
    "存储临时录制文件的位置。如果未设置，默认为存储路径下的一个文件夹。",
  [Phrase.RetailLogPathDescription]:
    '你魔兽世界正式服安装目录的 Logs 文件夹路径，例如 "D:\\World of Warcraft\\_retail_\\Logs"。',
  [Phrase.ClassicLogPathDescription]:
    '你魔兽世界怀旧服安装目录的 Logs 文件夹路径，例如 "D:\\World of Warcraft\\_classic_\\Logs"。',
  [Phrase.EraLogPathDescription]:
    '你魔兽世界经典旧世服安装目录的 Logs 文件夹路径，例如 "D:\\World of Warcraft\\_classic_era_\\Logs"。',
  [Phrase.MaxStorageDescription]:
    "应用程序可用于视频文件的最大存储容量。为了保持在此限制内，旧视频将按顺序被删除，但录制不会停止。如果设置为 0，则表示不限制。",
  [Phrase.MonitorIndexDescription]:
    "需要录制的显示器序号，仅在选择屏幕捕获模式时有效。",
  ...
  [Phrase.MinEncounterDurationDescription]:
    "低于此时长的首领战不会被录制。此设置旨在避免保存首领战的快速重置。",
  ...
  [Phrase.ObsOutputResolutionDescription]:
    "视频在硬盘上保存时的分辨率。可设置为魔兽世界所用显示器的大小，或者更低的分辨率以缩小视频。",
  [Phrase.ObsFPSDescription]:
    "录制视频的帧率。较低的帧率会减小视频体积，但回放画面也会更加卡顿。",
  [Phrase.ObsForceMonoDescription]:
    "是否将音频输入设备强制为单声道。如果你的麦克风声音只从一个立体声声道输出，请启用此选项。",
  [Phrase.ObsQualityDescription]:
    "录制质量。更高的质量会增加对编码器的压力，并且会产生更大的视频文件。",
  [Phrase.ObsCaptureModeDescription]:
    "OBS 用于录制的捕获模式。更多详细信息可见 Discord 中的 #faq 频道。",
  [Phrase.ObsRecEncoderDescription]:
    "要使用的视频编码器。通常来说，硬件编码器表现更好，但它依赖于你的显卡。",
  ...
  [Phrase.PushToTalkModifiersDescription]:
    "设置需要与按键说话热键一起按下的修饰键（用逗号分隔）。",
  [Phrase.PushToTalkReleaseDelayDescription]:
    "在您松开按下通话键（Push To Talk）后，麦克风保持激活的时长。",
  [Phrase.ObsAudioSuppressionDescription]:
    "抑制麦克风拾取的背景噪音，这有助于减少键盘敲击、呼吸声等。",
  ...
  [Phrase.CloudUploadDescription]:
    "将录制的视频上传到云端，这既支持在录制完成后自动上传，也允许手动上传现有视频。",
  [Phrase.CloudUploadRetailDescription]: "如果零售录音应该上传到云端。",
  [Phrase.CloudUploadClassicDescription]: "如果经典录音应该上传到云端。",
  ...
  [Phrase.TestButtonUnable]:
    "目前无法进行测试。要运行测试，魔兽世界必须在运行，设置必须正确，并且你不能处于任何活动中。",
  ...
  [Phrase.ChallengeModeLabel]: "录制挑战模式",
  ...
  [Phrase.CloudUploadRetailLabel]: "上传零售",
  [Phrase.CloudUploadClassicLabel]: "上传经典",
  ...
  [Phrase.CrashHappenedText]:
    "OBS 出现崩溃并已自动恢复。通常不应该发生。你可能需要在 Discord 中分享 WCR 和 OBS 日志以寻求帮助。",
  ...
  [Phrase.Activity]: "活动",
  [Phrase.Unknown]: "未知",
  [Phrase.NoneTagged]: "该行不包含标记的录制",
  [Phrase.MultipleTagged]: "该行包含多个标记的录制",
  [Phrase.NoneStarred]: "该行不包含收藏的录制",
  [Phrase.SomeStarred]: "该行至少包含一个收藏的录制",
  [Phrase.UploadClipsLabel]: "上传剪辑",
  [Phrase.CloudUploadClipsDescription]: "是否应将剪辑的录制上传到云端",
  ...
  [Phrase.MultiPlayerModeAdvice1]:
    "使用左侧的网格一次选择/取消选择最多 4 名玩家",
  [Phrase.MultiPlayerModeAdvice2]:
    "要恢复此处通常显示的按钮，请返回单人游戏模式",
  ...
  [Phrase.DateFilter]: "日期过滤器",
  [Phrase.DateFilterSeparator]: "到",
  [Phrase.Last7Days]: "过去 7 天",
  [Phrase.Last30Days]: "过去 30 天",
  [Phrase.ThisMonth]: "本月",
  [Phrase.LastMonth]: "上个月",
  [Phrase.Cancel]: "取消",
  [Phrase.Apply]: "应用",
  [Phrase.January]: "一月",
  [Phrase.February]: "二月",
  ...
  [Phrase.AudioProcessDevicesDescription]:
    "除了任何选定的扬声器和麦克风之外，还可以从中捕获音频的应用程序。",
  ...
  [Phrase.HardwareAccelerationDescription]:
    "启用应用程序的硬件加速渲染。建议大多数用户（尤其是使用 AV1 编码的用户）启用此功能，但在某些系统上可能会导致问题。",
  [Phrase.RecordCurrentRaidsOnlyLabel]: "仅记录当前突袭",
  [Phrase.RecordCurrentRaidsOnlyDescription]:
    "仅记录当前等级的突袭遭遇，这仅适用于零售突袭遭遇。",
  [Phrase.UploadCurrentRaidsOnlyLabel]: "仅上传当前突袭",
  [Phrase.UploadCurrentRaidsOnlyDescription]:
    "仅上传当前等级的突袭遭遇战，这仅适用于零售突袭遭遇战。",
  [Phrase.MustNotBeEmpty]: "不能为空",
  [Phrase.PushToTalkReleaseDelayLabel]: "释放延迟",
  [Phrase.ForceSdrLabel]: "强制 SDR",
  [Phrase.ForceSdrDescription]: "强制视频以 SDR 而非 HDR 格式渲染。",
  [Phrase.VideoSourceScaleDescription]: "视频源的缩放比例。",
  [Phrase.VideoSourceXPositionDescription]: "视频源的 X 位置。",
  [Phrase.VideoSourceYPositionDescription]: "视频源的 Y 位置。",
  [Phrase.VideoCategoryManualLabel]: "手动",
  [Phrase.ManualRecordSettingsLabel]: "手动录制设置",
  [Phrase.ManualRecordSwitchLabel]: "手动录制",
  [Phrase.ManualRecordHotKeyLabel]: "开始/停止热键",
  [Phrase.ManualRecordUploadLabel]: "上传手动录制",
  [Phrase.ManualRecordDescription]:
    "启用手动录制，用户可以按需开始和停止录制那些战斗日志无法捕获的内容。",
  [Phrase.ManualRecordHotKeyDescription]: "设置一个热键来手动开始和停止录制。",
  [Phrase.ManualRecordUploadDescription]: "自动将手动开始的录制上传到云端。",
  [Phrase.ManualRecordSoundAlertLabel]: "声音提醒",
  [Phrase.ManualRecordSoundAlertDescription]:
    "当手动录制开始或停止时播放声音提醒。",
  [Phrase.StatusTitleRec]: "录制器",
  [Phrase.StatusTitlePro]: "专业版",
  [Phrase.StatusTitleConnected]: "已连接",
  [Phrase.StatusDescrConnected]: "公会连接已建立。专业版功能已启用。",
  [Phrase.StatusTitleDisconnected]: "已断开",
  [Phrase.StatusDescrDisconnected]:
    "要使用专业版功能，请购买公会订阅或加入现有公会，并在专业版设置页面配置您的登录详细信息。",
  ...
  [Phrase.AutoSelectEncoderTooltip]:
    "自动从可用的编码器中选择一个合理的编码器。对于大多数用户来说，这是一个不错的选择。",
