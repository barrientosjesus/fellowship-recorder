...
const ENGLISH: Translations = {
  ...
  [Phrase.ChallengeModeLabel]: "Record Challenge Modes",
  ...
  [Phrase.WidthLabel]: "Crop X",
  [Phrase.HeightLabel]: "Crop Y",
  ...
  [Phrase.CrashHappenedText]:
    "An error has occured. This can result in dropped videos. You may wish to seek help by sharing your FS and OBS logs in discord.",
  ...
  [Phrase.StarSelected]:
    "Lock selected rows. Locked rows will not be automatically aged out.",
  [Phrase.UnstarSelected]:
    "Unlock selected rows. Unlocked rows may be automatically aged out to make space for new recordings.",
  ...
  [Phrase.HardwareAccelerationDescription]:
    "Enable hardware accelerated rendering of the application. This is recommended for users using AV1 encoding, but may cause issues on some systems. Requires a restart of the application to take effect.",
