...
export const getSettings = (): ConfigurationSchema => {
  ...
  const configValues = {
    ...
    cloudUploadRateLimitMbps: getConfigValue<number>(
    ...
    // Fellowship
    fellowshipLogPath: getConfigValue<string>("fellowshipLogPath"),
    recordQuickplays: getConfigValue<boolean>("recordQuickplays"),
    recordAdventures: getConfigValue<boolean>("recordAdventures"),
    minDifficultyLevel: getConfigValue<number>("minDifficultyLevel"),
    heroBlacklist: getConfigValue<number[]>("heroBlacklist"),
    cloudUploadQuickplays: getConfigValue<boolean>("cloudUploadQuickplays"),
    cloudUploadAdventures: getConfigValue<boolean>("cloudUploadAdventures"),
    recordFellowship: getConfigValue<boolean>("recordFellowship"),
  };
