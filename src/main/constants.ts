...
> = {
  [VideoCategory.Adventures]: {
    allowRecordKey: "recordAdventures",
    autoUploadKey: "cloudUploadAdventures",
  },
  ...
  [VideoCategory.Quickplays]: {
    allowRecordKey: "recordQuickplays",
    autoUploadKey: "cloudUploadQuickplays",
  },
 ...
 */
const AdventuresByLevelID: NumberKeyToStringValueMapType = {
  6: "Empyrean Sands",
  8: "Wyrmheart",
  11: "Everdawn Grove",
  12: "Stormwatch",
...
const dungeonAffixesById: NumberKeyToStringValueMapType = {
  ...
  4: "Vayr's Legacy",
  5: "Asha's Dilemma",
  6: "Celestia's Retreat",
  8: "Blood Shards",
  9: "Carnage",
  10: "Challenge",
  11: "Binding Ice",
  12: "Empowered Minions",
  13: "Malevolent Spirits",
  14: "Meteor Rain",
  15: "Stone Skin",
  16: "Ultimatum",
...
type HeroRoleType = "tank" | "healer" | "damage";
type HeroType =
  | "HELENA"
  | "SYLVIE"
  | "RIME"
...
const AllDungeonAndAdventureTimersByLevelId = {
