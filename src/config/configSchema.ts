...
export type ConfigurationSchema = {
  ...
  recordQuickplays: boolean;
  cloudUploadQuickplays: boolean;
  recordAdventures: boolean;
  cloudUploadAdventures: boolean;
  minDifficultyLevel: number;
  heroBlacklist: number[];
...
export const configSchema = {
  ...
  fellowshipLogPath: {
    description: Phrase.FellowshipLogPathDescription,
    type: "string",
    default: "",
  },
  retailLogPath: {
  ...
  heroBlacklist: {
    description: Phrase.HeroBlacklistDescription,
    type: "array",
    default: [],
  },
  recordFellowship: {
    description: Phrase.RecordFellowshipDescription,
    type: "boolean",
    default: true,
  },
  recordAdventures: {
    description: Phrase.RecordAdventuresDescription,
    type: "boolean",
    default: true,
  },
  recordQuickplays: {
    description: Phrase.RecordQuickplaysDescription,
    type: "boolean",
    default: false,
  },
  recordRetail: {
  ...
  minDifficultyLevel: {
    description: Phrase.MinDifficultyLevelDescription,
    type: "integer",
    default: 3,
  },
  minKeystoneLevel: {
  ...
  cloudUploadQuickplays: {
    description: Phrase.CloudUploadQuickplaysDescription,
    type: "boolean",
    default: true,
  },
  cloudUploadAdventures: {
    description: Phrase.CloudUploadAdventuresDescription,
    type: "boolean",
    default: true,
  },
  cloudAccountName: {
